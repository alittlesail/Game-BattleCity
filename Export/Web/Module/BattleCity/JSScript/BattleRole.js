	...
	WalkImpl : function(dir, frame_time, adjust) {
		if (dir === 1) {
			...
			if (this.y === target) {
				...
				if (!left_check) {
					return this.WalkImpl(4, frame_time, false);
				} else if (!right_check) {
					return this.WalkImpl(3, frame_time, false);
				}
				return false;
			}
			this.y = target;
		...
		if (dir === 3) {
			...
			if (this.x === target) {
				...
				if (!up_check) {
					return this.WalkImpl(2, frame_time, false);
				} else if (!down_check) {
					return this.WalkImpl(1, frame_time, false);
				}
				return false;
			}
			this.x = target;
